...
// const{joinValidator,loginValidator} = require('./middleware/middle2'); 쓸경우
app.use(joinValidator);
app.use(loginValidator);

// const middle2= require('./middleware/middle2'); 쓸경우
/*app.use(middle2.joinValidator);
