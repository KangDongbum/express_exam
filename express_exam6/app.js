...
app.use(session({
	resav : false, //같은 값을 저장할때 다시 저장할것인가? false - 저장 안하고 기존꺼 유지
	saveUninitialized : true, // 세션 값 지정 여부 상고나 없이 처음부터 session 아이디를 쿠키에 생성 true
...
/**
	...
	upload.single("file태그의 name 속성값"); - 파일 1개, req.file - 업로드된 파일 데이터
